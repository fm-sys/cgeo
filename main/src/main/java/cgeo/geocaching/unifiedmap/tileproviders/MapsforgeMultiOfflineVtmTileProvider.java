...
class MapsforgeMultiOfflineVtmTileProvider extends AbstractMapsforgeOfflineVtmTileProvider {

    private final List<ImmutablePair<String, Uri>> maps;

    MapsforgeMultiOfflineVtmTileProvider(final List<ImmutablePair<String, Uri>> maps) {
